...
vsim -L altera_mf_ver pong_game -gCLOCKS_PER_SECOND=100000 -gX_SCREEN_PIXELS=320 -gY_SCREEN_PIXELS=240 -gY_PADDLE_SIZE=5 -gX_PADDLE_SIZE=2 -gFRAMES_PER_UPDATE=1 -gWARNING_LEVEL=0
